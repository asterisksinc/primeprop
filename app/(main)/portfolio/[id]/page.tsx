...
function PropertyDetailsDashboard() {
    ...
    return (
        <div className="w-full mx-auto font-sans bg-[#fafafb] min-h-screen">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          
          {/* Left Column: Property Details */}
          <div className="bg-white rounded-[1.25rem] border border-gray-200 p-4 flex flex-col lg:col-span-2 shadow-sm">
            ...
            <div className="flex gap-4 mb-8 overflow-hidden">
              <div className="w-[18%] h-20 rounded-xl border-2 border-[#277079] bg-white flex-shrink-0"></div>
              {[...Array(4)].map((_, i) => (
                <div 
                  key={i} 
                  className="w-[18%] h-20 rounded-xl bg-[#d1d5db] flex-shrink-0"
                ></div>
              ))}
            </div>
                ...
                <div className="flex flex-col gap-6">
                  {activities.map((item, index) => (
                    <div key={index} className="relative flex items-start gap-4">
                      {/* Icon */}
                      <div className="w-8 h-8 rounded-full bg-[#277079] text-white flex items-center justify-center shrink-0 z-10 shadow-sm mt-1">
...
export default function AssetDetails() {
  ...
  return (
    <div className="w-full mx-auto p-4 md:p-6 font-sans flex flex-col gap-4 bg-[#fafafb] min-h-screen">
      
      {/* Top Hero Section */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        
        {/* Banner (Left) */}
        <div className="lg:col-span-2 relative h-64 md:h-72 rounded-[1.25rem] overflow-hidden shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
          <img 
        ...
        <div className="bg-white rounded-[1.25rem] p-6 border-2 border-[#FE5919] shadow-sm flex flex-col justify-between">
          <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="bg-white rounded-[1.25rem] p-5 border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.02)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-[1.25rem] p-6 border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.02)] lg:col-span-2 flex flex-col">
        ...
        <div className="bg-white rounded-[1.25rem] p-6 border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.02)] flex flex-col">
          <div className="flex justify-between items-center mb-4">
            ...
            <button className="bg-[#277079] hover:bg-[#1f5a61] text-white px-3 py-2 rounded-lg flex items-center gap-1.5 text-[16px] font-medium transition-colors">

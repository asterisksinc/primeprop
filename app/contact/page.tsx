        ...
        <div className="min-h-screen text-[#111111] overflow-x-hidden" style={{ fontFamily: '"Figtree", sans-serif' }}>
          ...
          <div className="w-full bg-white pt-[60px] pb-[100px] relative">
            <div className="max-w-[1200px] mx-auto px-5">
              {/* Two Column Layout */}
              <div className="flex gap-[40px] relative z-10 items-stretch">
                
                {/* Left Side - Location Header + Full Map */}
                <div className="flex-[0.55] flex flex-col">
                  ...
                  <div className="relative w-full flex-1 h-[504px] rounded-[16px] overflow-hidden bg-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
                    <a 
                      href="https://maps.google.com/?q=25.1212,55.180" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="absolute top-[16px] left-[16px] z-10 flex items-center gap-[6px] bg-white px-[12px] py-[8px] rounded-[6px] shadow-[0_2px_8px_rgba(0,0,0,0.08)] text-[12px] font-medium text-[#22C3D8] hover:bg-gray-50 transition-colors hidden"
                    >
                      Open in Maps
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#22C3D8" strokeWidth="2">
                ...
                <div className="flex-[0.45] bg-white rounded-[16px] p-[40px] shadow-[0_4px_20px_rgba(0,0,0,0.04)] h-fit">
                  <div className="text-[28px] font-semibold text-[#111111] mb-[8px]">Contact us</div>
                  ...
                  <form className="flex flex-col gap-[20px]">
                    ...
                    <div>
                      ...
                      <div className="flex h-[48px]">
                        {/* Country Code */}
                        <div className="flex items-center gap-[8px] px-[14px] border border-[#E0E0E0] border-r-0 rounded-l-[8px] bg-white cursor-pointer">
                          <img src="https://flagcdn.com/w20/ae.png" alt="UAE" className="w-[22px] h-[15px] object-cover rounded-[2px]" />
                        ...
                        <input 
                          ...
                          className="flex-1 h-full rounded-r-[8px] border border-[#E0E0E0] px-[16px] text-[14px] text-[#111111] placeholder-[#999999] focus:outline-none focus:border-[#FF6500] transition-colors"
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-[12px]">
                      ...
                      <label htmlFor="consent" className="text-[13px] font-normal leading-[20px] text-[#666666] cursor-pointer">
                        I agree to receive communications, including emails, calls, and texts, from FEU X about products, services, and promotions. I understand I can unsubscribe at any time.
                      </label>
                    </div>
                    ...
                    <button 
                      type="button" 
                      className="w-full h-[48px] bg-[#FF6500] text-white text-[14px] font-semibold rounded-[69px] hover:bg-[#e65b00] transition-colors mt-[8px]"
                    >
                      Submit
                    </button>
                  </form>

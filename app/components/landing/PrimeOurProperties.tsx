    ...
    return (
        <section className="bg-white py-6 sm:py-8 md:py-10 lg:py-12 text-black flex flex-col items-center justify-center">
            <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 px-4 sm:px-6">
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-center">Our Properties</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3  md:gap-6 my-6  md:my-10 px-4  md:px-8 lg:px-10 w-full max-w-7xl">
                {properties.map((property) => (
                    <div key={property.id} className="bg-white border border-gray-200 rounded-lg p-2 w-full overflow-hidden">
                        <div className="relative">
                            <img className="h-24 md:h-30 w-full object-cover rounded-lg overflow-hidden" src={property.image} alt={property.title} />
          ...
          <span className="rounded-[999px] bg-white/95 px-[10px] py-[4px] text-[12px] font-semibold leading-none text-[#277079]">
            Ready
                        ...
                        <div className="flex flex-col items-center justify-center gap-1 bg-[#EB6601]/20 py-3 rounded-lg  border border-[#EB6601]/30 mt-2 sm:mt-3">
